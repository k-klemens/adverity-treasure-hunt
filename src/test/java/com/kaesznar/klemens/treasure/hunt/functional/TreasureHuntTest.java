...
public class TreasureHuntTest {
  ...
  public void beforeEach() throws IOException {
    ...
    System.setIn(fakeIn);
    treasureMapWithTreasureAt13 = TreasureHuntUtil.readTreasureMapFromStdin(5);
    ...
    System.setIn(fakeIn);
    treasureMapWithTreasureAt55 = TreasureHuntUtil.readTreasureMapFromStdin(5);
    ...
    System.setIn(fakeIn);
    treasureMapWithTreasureAt43 = TreasureHuntUtil.readTreasureMapFromStdin(5);
    ...
    System.setIn(fakeIn);
    treasureMapWithOutOfBoundsClues = TreasureHuntUtil.readTreasureMapFromStdin(5);
    ...
    System.setIn(fakeIn);
    treasureMapWithCircle = TreasureHuntUtil.readTreasureMapFromStdin(5);
  }

  @Test
  public void testDoRecursiveHunt_givenTreasureAt13Fixture_ExpectRightHistory() {
    String computedHistory = TreasureHunt.startRecursiveHunt(treasureMapWithTreasureAt13, 11);
